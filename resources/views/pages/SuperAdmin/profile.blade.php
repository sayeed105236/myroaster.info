                                    ...
                                    <div role="tabpanel" class="tab-pane active" id="account-vertical-general" aria-labelledby="account-pill-general" aria-expanded="true">
                                        ...
                                        <div class="media">
                                            <a href="javascript:void(0);" class="mr-25">
                                                <img src="{{asset('storage/SuperAdmin/'. Auth::user()->image )}}" id="account-upload-img" class="rounded mr-50" alt="profile image" height="80" width="80" />
                                            </a>
                                            ...
                                            <div class="media-body mt-75 ml-1">
                                                ...
                                                <a href="#" data-toggle="modal" data-target="#editProfile" class="btn btn-sm btn-outline-primary mb-75">Edit Profile Photo</a>
                                                  @include('pages.SuperAdmin.edit_profile_modal')
                                        ...
                                        <!-- form -->
                                        <form action="{{route('super-admin-profile-update')}}" method="POST" class="validate-form mt-2">
                                          @csrf
                                            <div class="row">
