<div class="modal fade text-left" id="addCompany" tabindex="-1" role="dialog" aria-labelledby="myModalLabel17" aria-hidden="true">
                                      ...
                                      <div class="row">
                                          ...
                                          <div class="col-md-4 col-12">
                                              <div class="form-group">
                                                  ...
                                                  <input type="text" id="mname" class="form-control" placeholder="Middle name" name="mname" required />
                                              </div>
                                          </div>
                                          <div class="col-md-4 col-12">
                                              <div class="form-group">
