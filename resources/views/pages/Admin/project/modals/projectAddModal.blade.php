<div class="modal fade text-left" id="addProject" tabindex="-1" role="dialog" aria-labelledby="myModalLabel17" aria-hidden="true">
                                      ...
                                      <div class="row">
                                          <div class="col-md-6 col-12">
                                              <div class="form-group">
                                                  ...
                                                  <input type="text"  class="form-control" placeholder="Project Name" name="pName" required />
                                              </div>
                                          </div>
                                          ...
                                          <div class="col-md-6 col-12">
                                              <div class="form-group">
                                                  ...
                                                  <input type="text"  class="form-control" placeholder="Contact Number" name="cName" required />
                                              </div>
                                          </div>
                                          ...
                                          <div class="col-md-6 col-12">
                                              <div class="form-group">
                                                  ...
                                                  <input type="text"  class="form-control" name="cNumber" placeholder="Contact name" required />
                                              </div>
                                          </div>
                                          <div class="col-md-6 col-12">
                                              <div class="form-group">
