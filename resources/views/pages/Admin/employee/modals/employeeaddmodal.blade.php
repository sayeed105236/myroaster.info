<div class="modal fade text-left" id="addEmployee" tabindex="-1" role="dialog" aria-labelledby="myModalLabel17" aria-hidden="true">
                                      ...
                                      <div class="row">
                                          ...
                                          <div class="col-md-6 col-12">
                                              <div class="form-group">
                                                  ...
                                                  <input type="number"  class="form-control" name="rsa_number" placeholder="RSA Number" required/>
                                              </div>
                                          </div>
                                          <div class="col-md-6 col-12">
                                              <div class="form-group">
                                                  <label for="company-column">RSA Expire Date *</label>
                                                  <input type="date"  class="form-control" name="rsa_expire_date" placeholder="RSA Expire Date" required/>
                                              </div>
                                          </div>
                                          <div class="col-md-6 col-12">
                                              <div class="form-group">
                                          ...
                                          <div class="col-md-6 col-12">
                                              <div class="form-group">
                                                  ...
                                                  <input type="date"  class="form-control" name="license_expire_date" placeholder="License Expire Date" required/>
                                              </div>
                                          </div>
                                          <div class="col-md-6 col-12">
                                              <div class="form-group">
